  ...
  return (
    ...
    {/* About Section for desktop */}
      <div id='about' className=' hidden md:flex   scroll-mt-50 relative bg-white    overflow-hidden '>
        ...
        <div data-aos="fade-left"className='absolute hidden md:block md:top-30 bg-blue-500  md:right-31 flex  p-4 text-white     md:w-100 md:h-35  rounded-4xl text-justify text-wrap text-balance shadow-md '>
        ...
        <div data-aos="fade-right"className='absolute hidden md:block md:top-70 bg-blue-500  md:left-11 p-4 text-white    md:w-100 md:h-35 rounded-4xl text-justify text-wrap text-balance shadow-md'>
          <p className='text-wrap mt-3'><b>It offers</b> efficient shift management to handle multiple time slots smoothly, along with powerful member management to maintain detailed records, fees, and renewals.</p> 
           ...
           <div data-aos="fade-left"className='absolute hidden md:block md:top-100 bg-blue-500  md:right-15 p-5 text-white     md:w-100 md:h-35  rounded-4xl text-justify text-wrap text-balance shadow-md'>
        ...
        <div data-aos="fade-right"className='absolute hidden md:block md:top-160 bg-blue-500  md:left-20 p-5 text-white     md:w-100 md:h-35 rounded-4xl text-justify text-wrap text-balance shadow-md'>
          <p className='text-wrap mt-3'><b>Automated SMS reminders</b> help notify members about fee due dates, renewals, and important updates.</p> 
           ...
           <div data-aos="fade-left"className='absolute hidden md:block md:top-170 bg-blue-500  md:right-9 p-5 text-white     md:w-100 md:h-35  rounded-4xl text-justify text-wrap text-balance shadow-md'>
        ...
        <div data-aos="fade-right"className='absolute hidden md:block md:top-240 bg-blue-500  md:left-50 p-5 text-white     md:w-100 md:h-35  rounded-4xl text-justify text-wrap text-balance shadow-md'>
      ...
      <div id='about' className=' md:hidden relative scroll-mt-50  bg-white  overflow-hidden '>
           <section>
      ...
      <section>
      <p className='text-center  top-73 text-md text-black text-wrap p-4'> Our Library Management App is a complete solution designed to streamline and automate library operations.</p>
        </section>
     </div>
